...
Students should leave this module comfortable declaring functions in all three forms, using default/rest parameters, and working individually with filter, sort, map, and reduce before composing them into pipelines.
