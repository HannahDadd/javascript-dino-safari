      ...
      <div className="flex flex-col md:flex-row items-center gap-10 max-w-4xl">
        ...
        <div className="text-center md:text-left">
          ...
          <p className="text-xl text-gray-300 mb-2">
            Created JavaScript in <strong className="text-white">10 days</strong> at Netscape, May 1995.
          </p>
          <p className="text-lg text-gray-400">
            His brief was: "make it look like Java, but make it for
            non-programmers." What he actually built was something
